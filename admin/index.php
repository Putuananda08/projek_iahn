  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        echo "<button>Tanggal : <b>" . date("d F Y", $tanggal) . "</b> </button>";
      ...
      <br>
      <section class="content-header">
        <div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Om Swastyastu, Selamat Datang <?php echo $_SESSION['nama']; ?> Di Aplikasi Pengajuan Cuti Berbasis Website.</div>
      </section>
      ...
      <section class="content">
        ...
        <div class="row">
          <?php $tampil = mysqli_query($koneksi, "select * from karyawan order by nip desc");
          ...
          <?php $tampil3 = mysqli_query($koneksi, "select * from cuti order by nip desc");
          ...
          <?php $tampil4 = mysqli_query($koneksi, "select * from atasan order by nip_atasan desc");
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-primary">
              ...
              <a href="nip-atasan.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div><!-- ./col -->
          ...
          <section class="col-lg-6 connectedSortable">
            ...
            <div class="box box-primary">
              <div class="box-header">
                ...
                <h3 class="box-title">Cuti Pegawai dan Dosen Yang Habis / Kurang</h3>
                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <center><?php echo $data['jumlah_cuti']; ?> Hari</center>
                        </td>
                      </tr>
              </div>
            <?php
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='admin.php' class="btn btn-sm btn-success" >Refresh</i></a>
            ...
            <?php
            $tgl = date("Y-m-d");
            $query1 = "select karyawan.*, cuti.* from karyawan, cuti where karyawan.nip=cuti.nip and cuti.tanggal_mulai='$tgl'";
              ...
              ?>
                <tbody>
                  <tr>
                    ...
                    <td>
                      <center><?php echo $data['jumlah_cuti']; ?> </center>
                    </td>
                    <td>
                      <center><?php echo $data['keterangan_cuti']; ?> </center>
                    </td>
                  </tr>
          </div>
        <?php

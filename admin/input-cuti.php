...
$query = mysqli_query($koneksi, "INSERT INTO cuti (kode, nip, tanggal_awal, tanggal_akhir, jumlah, jenis_cuti, ket, status) VALUES ('$kode', '$nip', '$tanggal_awal', '$tanggal_akhir', '$jumlah', '$jenis_cuti', '$ket', '$status')");

$qu	   = mysqli_query($koneksi, "UPDATE karyawan SET jumlah_cuti=(jumlah_cuti-'$jumlah') WHERE nip='$nip'");
if ($query&&$qu){

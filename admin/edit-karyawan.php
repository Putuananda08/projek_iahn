...
<?php include "waktu.php"; ?>
	...
	{			
      ...
      $sql="UPDATE karyawan SET nama='$nama', tanggal_masuk='$tanggal_masuk', departemen='$departemen', jabatan='$jabatan', status='$status', jumlah_cuti='$jumlah_cuti',  username='$username',  password='$password',  level='$level', gambar='$gambar' WHERE nip='$kd'";
       ...
       echo '<div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Anda Belum Memilih Gambar</div>';
			...
			?>
              ...
              <?php
                    ...
                    $tampil1=mysqli_query($koneksi, $query3) or die(mysqli_error($koneksi));

      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Pegawai/Dosen</li>
          </ol>
        </section>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Input Data Pegawai/Dosen</h3>
      ...
      if (!empty($_FILES["nama_file"]["tmp_name"]))
      {
        ...
        {			
          ...
          if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
            $sql="INSERT INTO karyawan (nip,nama,tanggal_masuk,departemen,jabatan,status,jumlah_cuti,username,password,level,gambar) VALUES
                  ('$nip','$nama','$tanggal_masuk','$departemen','$jabatan','$status','$jumlah_cuti','$username','$password','$level','$gambar')";

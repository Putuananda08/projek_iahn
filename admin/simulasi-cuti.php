      ...
      <div class="content-wrapper">
        ...
        $cut = $_GET['cuti'];
				...
				if(mysqli_num_rows($cek) == 0){
					...
					$delete = mysqli_query($koneksi, "UPDATE karyawan SET jumlah_cuti=(jumlah_cuti+$cut) WHERE nip='$nip'");
					if($delete){
...
<?php
                  ...
                  <thead>
                    ...
                    ?> Hari</center></td>
                    <td><a href="simulasi-cuti.php?aksi=update&&cuti=<?php echo $valcuti; ?>&&nip=<?php echo $data['nip']; ?>" class="btn btn-sm btn-primary">Input Cuti</a></td>
                    </tr> <?php   
              } 
              ?>
                   </tbody>

              ...
              <div class="box-body">
                ...
                if ($msg) : ?>
                  <div style="margin-right: 9px;">
                    <div class="col-md-6 col-md-3 alert alert-success"><i class="fa fa-check-circle" aria-hidden="true"></i><a href="#"><button type="button" class="close"><span>&times;</span></button></a>&emsp;<?php echo $msg; ?>&nbsp;&nbsp;<a href="karyawan.php"> Lihat disini</a></div>
                  </div>
                <?php endif; ?>
                <!--  -->
                <?php
                ...
                <form action="upload.php?data=pegawai" method="post" enctype="multipart/form-data">

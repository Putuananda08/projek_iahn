...
//      setelah data dibaca, masukkan ke tabel pegawai sql
      $query = "INSERT INTO karyawan (nip, nama, tanggal_masuk, departemen, jabatan, status, jumlah_cuti, username, password, level) VALUES 
                      ('$nip', '$nama', '$tanggal_masuk', '$departemen', '$jabatan', '$status', '$jumlah_cuti', '$username', '$password', '$level')";

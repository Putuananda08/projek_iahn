        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="box box-primary">
              ...
              <?php
              $kd = $_GET['id'];
              $sql = mysqli_query($koneksi, "SELECT * FROM karyawan WHERE nip='$kd'");
                ...
                if (!empty($_FILES["nama_file"]["tmp_name"])) {
                  ...
                  if ($jenis_gambar == "image/jpeg" || $jenis_gambar == "image/jpg" || $jenis_gambar == "image/gif" || $jenis_gambar == "image/x-png") {
                    ...
                    if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
                      $sql = "UPDATE karyawan SET nip='$nip',nama='$nama', tanggal_masuk='$tanggal_masuk', departemen='$departemen', status='$status', jumlah_cuti='$jumlah_cuti',  username='$username',  password='$password',  level='$level', gambar='$gambar' WHERE nip='$kd'";
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <select name="departemen" id="departemen" class="form-control select2" required>
                        ...
                        $tampil2 = mysqli_query($koneksi, $query4) or die(mysqli_error($koneksi));
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <select name="status" id="status" class="form-control" required="required">
                        ...
                        <option <?= ($statuskerja == 'PEGAWAI') ? 'selected="selected"' : '' ?>>PEGAWAI</option>
                        <option <?= ($statuskerja == 'DOSEN') ? 'selected="selected"' : '' ?>>DOSEN</option>
                      </select>
                    </div>
                  </div>

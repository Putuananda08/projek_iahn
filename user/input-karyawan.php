                ...
                if (!empty($_FILES["nama_file"]["tmp_name"])) {
                  ...
                  if ($jenis_gambar == "image/jpeg" || $jenis_gambar == "image/jpg" || $jenis_gambar == "image/gif" || $jenis_gambar == "image/x-png") {
                    ...
                    if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
                      $sql = "INSERT INTO karyawan (nip,nama,tanggal_masuk,departemen,status,jumlah_cuti,username,password,level,gambar) VALUES
                  ('$nip','$nama','$tanggal_masuk','$departemen','$status','$jumlah_cuti','$username','$password','$level','$gambar')";

            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Detail Data Pengajuan Cuti</h3>
                  <div class="box-tools pull-right">
                
                  </div> 
                </div><!-- /.box-header -->
                <?php
            $query = mysqli_query($koneksi, "SELECT * FROM pengajuan_cuti WHERE nip='$_GET[id]'");
            ...
            ?>
                <div class="box-body">
                  ...
                  <table id="example" class="table table-hover table-bordered">
                      ...
                      <td><?php echo $data['sisa_cuti_n2']; ?></td>
                      </tr>
                      <tr>
                      <td>Sisa Cuti N-1</td></td>
                      <td><?php echo $data['sisa_cuti_n1']; ?></td>
                      </tr>
                      <tr>
                      <td>Sisa Cuti N</td></td>
                      <td><?php echo $data['sisa_cuti_n']; ?></td>
                      </tr>
                      <tr>
                  ...
                  <a href="pengajuan-cuti.php" class="btn btn-sm btn-warning">Kembali <i class="fa fa-arrow-circle-right"></i></a>
